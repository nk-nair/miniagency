...
const works = [
  { t: 'The Green Hero of India', cat: 'Films', tag: 'Documentary', span: 'md:col-span-2 md:row-span-2' },
  { t: 'A Day in a Life of an Orthopedic Surgeon', cat: 'Films', tag: 'Vlog' },
  { t: 'Crest Container Lines', cat: 'Films', tag: 'Corporate' },
  { t: 'CMR Surgical Equipments', cat: 'Films', tag: 'Corporate' },
  { t: 'LTTS × Forest Creators', cat: 'Films', tag: 'CSR' },
  { t: 'Shreeji Hospital', cat: 'Films', tag: 'Corporate' },
  { t: 'IIM Nagpur', cat: 'Photography', tag: 'Architecture', span: 'md:col-span-2' },
  { t: 'Kilitch Drugs', cat: 'Photography', tag: 'Industrial' },
  { t: 'Sports Ortho', cat: 'Branding', tag: 'Identity' },
  { t: 'All Women’s Clinic', cat: 'Branding', tag: 'Identity' },
  { t: 'Forest Creators', cat: 'Social Media', tag: 'Reels' },
  { t: 'Maahi Ve', cat: 'Films', tag: 'Ad Campaign' },
]
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 auto-rows-[240px] md:auto-rows-[280px] gap-4">
          {shown.map((w, i) => (
            ...
            >
              {/* Swap this div for <img src={`/work/${slug}.jpg`} /> when assets ready */}
              ...
              <div className="absolute inset-0 opacity-20 bg-[linear-gradient(135deg,transparent_25%,rgba(232,165,152,0.15)_50%,transparent_75%)]" />
